...
(function() {
    ...
    if (BROWSER.ie && BROWSER.ie < 10) {
        ...
        var string = sectplcode[0] + "验证" + sectplcode[1] + '<input name="seccodehash" type="hidden" value="' + idhash + '" /><span id="checkseccodeverify_' + idhash + '" style="display:none"><img src="static/image/common/check_right.gif" width="16" height="16" class="vm"></span><input name="seccodeverify" id="seccodeverify_' + idhash + '" type="hidden" value="' + idhash + '" /><div class="g-recaptcha" data-sitekey="6Lc9ncYZAAAAAGixx4tGz6CYcD4wwqcg1FH3VzuG"></div><span id="' + onloadid + '"><img src="static/image/common/loading.gif" class="vm"></span><a class="xi2" style="margin-left:6px" href="misc.php?mod=faq"><img src="static/image/common/info_small.gif" class="vm" onmouseover="showTip(this)" tip="点此查看帮助"></a>' + sectplcode[2] + sectplcode[3];
